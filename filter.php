...
if (!(isset($_SESSION['user_id']))) {
    ...
    $search=$_GET['search'];
    $sql = "SELECT * FROM PRODUCT P INNER JOIN SHOP ON P.SHOP_ID=SHOP.SHOP_ID,P.IS_DISABLED='false' INNER JOIN SHOP_REQUEST ON SHOP.SHOP_REQUEST_ID=SHOP_REQUEST.SHOP_REQUEST_ID WHERE (LOWER(P.PRODUCT_NAME) LIKE LOWER('%$search%')) OR (LOWER(SHOP_REQUEST.CATEGORY) LIKE LOWER('%$search%'))";
